...
namespace ListViewEx
{
    ...
    public class ListViewEx : System.Windows.Forms.ListView
    {
        ...
        private bool _lockColumns = false;
        public bool LockColumns
        {
            get { return _lockColumns; }
            set { _lockColumns = value; }
        }
            ...
            switch (msg.Msg)
            {
                ...
                case WM_NOTIFY:
                    ...
                    if (h.code == HDN_BEGINDRAG ||
                        ...
                        EndEditing(false);
                    else if (h.code == HDN_BEGINTRACKA || h.code == HDN_BEGINTRACKW)
                    {
                        if (_lockColumns)
                        {
                            msg.Result = (IntPtr)1;
